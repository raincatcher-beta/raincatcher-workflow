...
WorkflowMediatorService.prototype.getErrorAndDoneTopicPromises = function getErrorAndDoneTopicPromises(topicGenerator, topicName, topicUid) {
  ...
  return MediatorTopicUtility.getErrorAndDoneTopicPromises(topicDefaults, topicGenerator, topicName, topicUid);
};
...
WorkflowMediatorService.prototype.listResults = function listResults() {
  var promise = MediatorTopicUtility.getErrorAndDoneTopicPromises(topicDefaults, this.resultsTopics, CONSTANTS.TOPICS.LIST);
...
WorkflowMediatorService.prototype.createResult = function createResult(resultToCreate) {
  ...
  var promise = MediatorTopicUtility.getErrorAndDoneTopicPromises(topicDefaults, this.resultsTopics, CONSTANTS.TOPICS.CREATE, topicUid);
...
WorkflowMediatorService.prototype.updateResult = function updateResult(resultToUpdate) {
  var topicUid = shortid.generate();
  var promise = MediatorTopicUtility.getErrorAndDoneTopicPromises(topicDefaults, this.resultsTopics, CONSTANTS.TOPICS.UPDATE, topicUid);
...
WorkflowMediatorService.prototype.list = function listWorkflows() {
  var promise = MediatorTopicUtility.getErrorAndDoneTopicPromises(topicDefaults, this.workflowSyncSubscribers, CONSTANTS.TOPICS.LIST);
...
WorkflowMediatorService.prototype.listWorkorders = function listWorkorders() {
  var promise = MediatorTopicUtility.getErrorAndDoneTopicPromises(topicDefaults, this.workordersTopics, CONSTANTS.TOPICS.LIST);
...
WorkflowMediatorService.prototype.readWorkorder = function readWorkorder(workorderId) {
  var promise = MediatorTopicUtility.getErrorAndDoneTopicPromises(topicDefaults, this.workordersTopics, CONSTANTS.TOPICS.READ, workorderId);
...
WorkflowMediatorService.prototype.read = function readWorkflow(workflowId) {
  var promise = MediatorTopicUtility.getErrorAndDoneTopicPromises(topicDefaults, this.workflowSyncSubscribers, CONSTANTS.TOPICS.READ, workflowId);
...
WorkflowMediatorService.prototype.update = function updateWorkflow(workflowToUpdate) {
  var promise = MediatorTopicUtility.getErrorAndDoneTopicPromises(topicDefaults, this.workflowSyncSubscribers, CONSTANTS.TOPICS.UPDATE, workflowToUpdate.id);
...
WorkflowMediatorService.prototype.create = function createWorkflow(workflowToCreate) {
  var topicUid = shortid.generate();
  var promise = MediatorTopicUtility.getErrorAndDoneTopicPromises(topicDefaults, this.workflowSyncSubscribers, CONSTANTS.TOPICS.CREATE, topicUid);
...
WorkflowMediatorService.prototype.remove = function removeWorkorder(workflowToRemove) {
  ...
  var promise = MediatorTopicUtility.getErrorAndDoneTopicPromises(topicDefaults, this.workflowSyncSubscribers, CONSTANTS.TOPICS.REMOVE, workflowToRemove.id);
...
WorkflowMediatorService.prototype.readUserProfile = function readUserProfile() {
  var promise = MediatorTopicUtility.getErrorAndDoneTopicPromises(topicDefaults, this.usersTopics, CONSTANTS.TOPICS.READ_PROFILE);
